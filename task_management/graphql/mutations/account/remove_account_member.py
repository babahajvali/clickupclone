...
from task_management.graphql.types.error_types import (
    AccountNotFoundType,
    InactiveAccountType,
    ModificationNotAllowedType, AccountMemberNotFoundType
)
from task_management.graphql.types.input_types import (
    RemoveAccountMemberInputParams
)
...
class RemoveAccountMemberMutation(graphene.Mutation):
    class Arguments:
        params = RemoveAccountMemberInputParams(required=True)

    Output = RemoveAccountMemberResponse
