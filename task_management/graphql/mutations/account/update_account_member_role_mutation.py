...
from task_management.graphql.types.error_types import (
    AccountNotFoundType,
    InactiveAccountType,
    UnexpectedRoleType, ModificationNotAllowedType, AccountMemberNotFoundType,
)
from task_management.graphql.types.input_types import (
    UpdateAccountMemberRoleInputParams,
)
from task_management.graphql.types.response_types import (
    UpdateAccountMemberRoleResponse,
)
...
class UpdateAccountMemberRoleMutation(graphene.Mutation):
    class Arguments:
        params = UpdateAccountMemberRoleInputParams(required=True)

    Output = UpdateAccountMemberRoleResponse
    ...
    def mutate(root, info, params):
        ...
        except custom_exceptions.AccountMemberNotFoundException as e:
            return AccountMemberNotFoundType(
                account_member_id=e.account_member_id)