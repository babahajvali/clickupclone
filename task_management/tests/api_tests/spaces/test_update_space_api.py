...
from task_management.tests.api_tests.spaces import BaseUpdateSpace
...
class TestUpdateSpaceAPI(BaseUpdateSpace):
    ...
    def test_update_space_successfully(self, snapshot, mocker):
        ...
        update_space = update_space_mock(mocker)
        update_space.return_value = make_space()
    ...
    def test_update_space_not_found(self, snapshot, mocker):
        get_space = get_space_mock(mocker)
    ...
    def test_update_space_deleted(self, snapshot, mocker):
        get_space = get_space_mock(mocker)
        get_space.return_value = make_space(is_deleted=True)
