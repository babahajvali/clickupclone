...
from task_management.tests.api_tests.users import BaseGetUserProfile
...
class TestGetUserProfileAPI(BaseGetUserProfile):
    def test_get_user_profile_successfully(self, snapshot, mocker):
        get_user_mock(mocker).return_value = make_user_dto()
    ...
    def test_get_user_profile_not_found(self, snapshot, mocker):
    ...
    def test_get_user_profile_inactive(self, snapshot, mocker):
