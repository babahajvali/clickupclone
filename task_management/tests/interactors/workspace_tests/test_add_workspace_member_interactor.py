...
class TestAddWorkspaceMemberInteractor:
    ...
    def setup_method(self):
        ...
        self.interactor = CreateWorkspaceMemberInteractor(
    ...
    def test_add_member_to_workspace_success(self):
        ...
        self.workspace_storage.create_workspace_member.return_value = expected

        result = self.interactor.create_workspace_member(dto)

        assert result == expected
        self.workspace_storage.create_workspace_member.assert_called_once_with(
            workspace_member_dto=dto
        )
