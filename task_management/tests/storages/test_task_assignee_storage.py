...
from task_management.tests.factories.storage_factory import \
    TaskAssigneeFactory, TaskFactory, UserFactory, ListFactory
...
class TestTaskAssigneeStorage:
    ...
    def test_assign_task_assignee_success(self, snapshot):
        ...
        UserFactory(user_id=assigned_by_id)
        TaskFactory(task_id=task_id, list=list_obj, created_by=user)
        storage = TaskStorage()

        # Act
        result = storage.add_task_assignee(task_id=str(task_id),
                                           user_id=str(user_id),
    ...
    def test_remove_task_assignee_success(self, snapshot):
        ...
        TaskAssigneeFactory(assign_id=assign_id, task=task, user=user,
        ...
        snapshot.assert_match(repr(result),
                              "test_remove_task_assignee_success.txt")
    ...
    def test_get_task_assignee_success(self, snapshot):
        ...
        # Assert
        snapshot.assert_match(repr(result),
                              "test_get_task_assignee_success.txt")
    ...
    def test_get_task_assignees_success(self, snapshot):
        ...
        TaskAssigneeFactory(assign_id=assign_id1, task=task, user=user1,
                            assigned_by=assigned_by)
        TaskAssigneeFactory(assign_id=assign_id2, task=task, user=user2,
                            assigned_by=assigned_by)
        storage = TaskStorage()
        ...
        # Assert
        snapshot.assert_match(repr(result),
                              "test_get_task_assignees_success.txt")
    ...
    def test_get_task_assignees_empty(self, snapshot):
        ...
        # Assert
        snapshot.assert_match(repr(result),
                              "test_get_task_assignees_empty.txt")
    ...
    def test_get_user_assigned_tasks_success(self, snapshot):
        ...
        user = UserFactory(user_id=user_id)
        assigned_by = UserFactory(user_id=assigned_by_id)
        task1 = TaskFactory(task_id=task_id1, list=list_obj, created_by=user,
                            is_deleted=False)
        task2 = TaskFactory(task_id=task_id2, list=list_obj, created_by=user,
                            is_deleted=False)
        task3 = TaskFactory(task_id=task_id3, list=list_obj, created_by=user,
                            is_deleted=True)
        TaskAssigneeFactory(assign_id=assign_id1, task=task1, user=user,
                            assigned_by=assigned_by, is_active=True)
        TaskAssigneeFactory(assign_id=assign_id2, task=task2, user=user,
                            assigned_by=assigned_by, is_active=True)
        TaskAssigneeFactory(assign_id=assign_id3, task=task3, user=user,
                            assigned_by=assigned_by, is_active=True)
        storage = TaskStorage()
        ...
        # Assert
        snapshot.assert_match(repr(result),
                              "test_get_user_assigned_tasks_success.txt")
    ...
    def test_get_user_assigned_tasks_empty(self, snapshot):
        ...
        # Assert
        snapshot.assert_match(repr(result),
                              "test_get_user_assigned_tasks_empty.txt")
    ...
    def test_get_user_task_assignee_success(self, snapshot):
        ...
        # Act
        result = storage.get_user_task_assignee(user_id=str(user_id),
                                                task_id=str(task_id),
                                                assigned_by=str(
                                                    assigned_by_id))
        ...
        # Assert
        snapshot.assert_match(repr(result),
                              "test_get_user_task_assignee_success.txt")
    ...
    def test_get_user_task_assignee_failure(self, snapshot):
        ...
        # Assert
        snapshot.assert_match(repr(result),
                              "test_get_user_task_assignee_failure.txt")
    ...
    def test_reassign_task_assignee_success(self, snapshot):
        ...
        task = TaskFactory(task_id=task_id, list=list_obj, created_by=user)
        TaskAssigneeFactory(assign_id=assign_id, task=task, user=user,
                            assigned_by=assigned_by, is_active=False)
        storage = TaskStorage()
        ...
        # Assert
        snapshot.assert_match(repr(result),
                              "test_reassign_task_assignee_success.txt")
