...
from task_management.tests.factories.storage_factory import ListFactory, TemplateFactory, SpaceFactory, FolderFactory, UserFactory
...
class TestListStorage:
    ...
    def test_get_template_id_by_list_id_success(self, snapshot):
        ...
        # Assert
        snapshot.assert_match(repr(result), "test_get_template_id_by_list_id_success.txt")
    ...
    def test_update_list_success(self, snapshot):
        ...
        # Act
        result = storage.update_list(update_list_data=update_list_data)
    ...
    def test_get_folder_lists_success(self, snapshot):
        ...
        # Assert
        snapshot.assert_match(repr(result), "test_get_folder_lists_success.txt")
    ...
    def test_make_list_private_success(self, snapshot):
        ...
        # Assert
        snapshot.assert_match(repr(result), "test_make_list_private_success.txt")
    ...
    def test_make_list_public_success(self, snapshot):
        ...
        # Assert
        snapshot.assert_match(repr(result), "test_make_list_public_success.txt")
    ...
    def test_reorder_list_in_folder_move_down_success(self, snapshot):
        ...
        # Act
        result = storage.reorder_list_in_folder(folder_id=str(folder_id), list_id=str(list_id), order=3)

        # Assert
        snapshot.assert_match(repr(result), "test_reorder_list_in_folder_move_down_success.txt")
    ...
    def test_reorder_list_in_folder_move_up_success(self, snapshot):
        ...
        # Act
        result = storage.reorder_list_in_folder(folder_id=str(folder_id), list_id=str(list_id), order=1)

        # Assert
        snapshot.assert_match(repr(result), "test_reorder_list_in_folder_move_up_success.txt")
    ...
    def test_reorder_list_in_folder_same_position(self, snapshot):
        ...
        # Act
        result = storage.reorder_list_in_folder(folder_id=str(folder_id), list_id=str(list_id), order=2)

        # Assert
        snapshot.assert_match(repr(result), "test_reorder_list_in_folder_same_position.txt")
    ...
    def test_reorder_list_in_space_move_down_success(self, snapshot):
        ...
        # Act
        result = storage.reorder_list_in_space(space_id=str(space_id), list_id=str(list_id), order=3)

        # Assert
        snapshot.assert_match(repr(result), "test_reorder_list_in_space_move_down_success.txt")
    ...
    def test_reorder_list_in_space_move_up_success(self, snapshot):
        ...
        # Act
        result = storage.reorder_list_in_space(space_id=str(space_id), list_id=str(list_id), order=1)

        # Assert
        snapshot.assert_match(repr(result), "test_reorder_list_in_space_move_up_success.txt")
    ...
    def test_reorder_list_in_space_same_position(self, snapshot):
        ...
        # Act
        result = storage.reorder_list_in_space(space_id=str(space_id), list_id=str(list_id), order=2)

        # Assert
        snapshot.assert_match(repr(result), "test_reorder_list_in_space_same_position.txt")
    ...
    def test_get_folder_lists_count_success(self, snapshot):
        ...
        # Assert
        snapshot.assert_match(repr(result), "test_get_folder_lists_count_success.txt")
    ...
    def test_get_folder_lists_count_empty(self, snapshot):
        ...
        # Assert
        snapshot.assert_match(repr(result), "test_get_folder_lists_count_empty.txt")
    ...
    def test_get_space_lists_count_success(self, snapshot):
        ...
        # Assert
        snapshot.assert_match(repr(result), "test_get_space_lists_count_success.txt")
    ...
    def test_get_space_lists_count_empty(self, snapshot):
        ...
        # Assert
        snapshot.assert_match(repr(result), "test_get_space_lists_count_empty.txt")