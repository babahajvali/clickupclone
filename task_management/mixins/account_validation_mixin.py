...
class AccountValidationMixin:
    ...
    def check_account_is_active(self, account_id: str):
        ...
        account_dto = self.check_account_exists(account_id=account_id)

        is_account_inactive = not account_dto.is_active
    ...
    def check_user_is_account_owner(self, user_id: str, account_id: str):
        ...
        account_dto = self.account_storage.get_account(account_id=account_id)

        is_not_account_owner = str(account_dto.owner_id) != user_id
    ...
    def check_account_exists(self, account_id: str) -> AccountDTO:
        ...
        is_account_not_found = not account_dto
    ...
    def check_account_name_in_db(
        ...
        is_account_name_exist = self.account_storage.is_account_name_exists(
            account_name=account_name, excluded_account_ids=[account_id])
