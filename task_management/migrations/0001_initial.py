# Generated by Django 4.2.7 on 2026-03-04 10:38
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "entity_type",
                    models.CharField(
                        choices=[("FOLDER", "Folder"), ("SPACE", "Space")],
                        max_length=255,
                    ),
                ),
        ...
        migrations.AddIndex(
            model_name="list",
            index=models.Index(
                fields=["entity_type"], name="task_manage_entity__6b0c75_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="list",
            index=models.Index(
                fields=["entity_id"], name="task_manage_entity__5313e6_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="list",
            index=models.Index(
                ...
                name="task_manage_entity__190e77_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="folder",
